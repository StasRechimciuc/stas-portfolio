...
const Contact = () => {
  ...
  const handleSubmit = e => {
    ...
    emailjs.send('service_5dqyxvc', 
    'template_kl4ukp1',
    {from_name: form.name,
     to_name: 'Stas',
     from_email: form.email,
     to_email: 'stasrechimciumciuc@gmail.com',
  ...
  return (
    <div className="xt:mt-12  xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div 
      ...
      >
        ...
        >
          ...
          className="flex flex-col">
            ...
            className="bg-tertiary py-4 px-6 text-white rounder-lg outline-none border-none font-medium"
            />
          </label>
          <label 
          className="flex flex-col">
